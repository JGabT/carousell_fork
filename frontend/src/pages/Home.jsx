          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-6 py-4 rounded-full text-text text-lg focus:outline-none focus:ring-4 focus:ring-white/30"
              />
              <button
                type="submit"
                className="px-8 py-4 bg-white text-primary rounded-full font-semibold hover:bg-gray-100 transition-colors"
              >
                Search
              </button>
            </div>
        ...
        {filteredProducts.length === 0 && !loading && (
          <div className="text-center py-12">
            <p className="text-gray-600 text-lg">
              {searchQuery.trim() ? 'No products found matching your search' : 'No products available at the moment'}
            </p>
          </div>
        )}
      </main>
